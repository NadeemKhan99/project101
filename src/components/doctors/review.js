    ...
    return (
        <div className="review_form">
            ...
            <h5>Tuesday</h5>
            {
             ...
             <h5>Wednesday</h5>
            {
                wednesday_slots.numberOfTickets !== "" ?
             ...
             <h5>Thursday</h5>
            {
                thursday_slots.numberOfTickets !== "" ?
             ...
             <h5>Friday</h5>
            {
             ...
             <h5>Saturday</h5>
            {
                saturday_slots.numberOfTickets !== "" ?
            ...
            <button onClick={() => submit(2)}>Back</button>

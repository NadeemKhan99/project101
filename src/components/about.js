                ...
                <div className="container py-5">
                    <div className="row h-100 align-items-center py-5">
                        <div className="col-lg-6">
                            ...
                            <p className="lead text-muted mb-0">We are a non-profit organization working to make our country's health system better by the use of technology. We aim
		to provide fast and efficient appointment facility to patients across Pakistan.</p>
                            <p className="lead text-muted">Snippet by
        </p>
                        </div>
                ...
                <div className="container py-5">
                    <div className="row align-items-center mb-5">
                        <div className="col-lg-6 order-2 order-lg-1"><i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                            ...
                            <p className="font-italic text-muted mb-4">Our mission is to bring millions of patients and thosands of doctors at one platform.</p>
                        </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6"><i className="fa fa-leaf fa-2x mb-3 text-primary"></i>
                            ...
                            <p className="font-italic text-muted mb-4">We are also working hard to make our health system autonomous by the use of AI. <br></br>
  ...
  <div className="container py-5">
    ...
    <div className="row text-center">
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4"><img src={ali} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4"><img src={khan} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4"><img src={aqeel} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
